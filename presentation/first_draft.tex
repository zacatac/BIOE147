...
\title[RNA circuits]{Riboregulators } % The short title appears at the bottom of every slide, the full title is only on the title page
...
\medskip
\textit{field.zackery@berkeley.edu, } % Your email address
}
...
\subsection{Biology as engineering discipline} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks

\begin{frame}
\frametitle{Biology as engineering discipline}
...
\begin{itemize}
\item Invalidation of the Jurrassic Park and NASA discovery based projects.
\item Proof of functional completeness
\item (Possibilities discussed later, although implied by completeness) 

\item technical reasoning for Riboregulators. 
  \begin{itemize}
    \item Orthogonal
    \item Predictable
    \item Safe
    \item Independence (special case of orthogonality)
    \item FILL IN MORE
  \end{itemize}
\end{itemize}
\end{frame}
