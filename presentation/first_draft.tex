...
\title[RNA circuits]{Self-contained RNA inhibition with self-cleaving ribozymes} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\subsection{Novel Circuits and Systems in Biology} % A subsection can be created just before a set of slides with a common theme to further break down your presentation into chunks
